...
class PDMBoothDataset(Dataset):
    ...
    def __init__(
        ...
        tokenizer_max_length=None, inst_features_root: str = None, save_pdm_fs: bool = None, do_extract_pdm_fs: bool = False, sam_processor: SamProcessor = None, sam_model: SamModel = None,
